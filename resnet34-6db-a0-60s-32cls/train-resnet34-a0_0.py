...
def run_train():
    fold = 1
    global out_dir
    out_dir = ROOT_PATH + '/CinC2021_logs/result-resnet34-6db-a%d-60s-27cls'%(fold)
    # initial_checkpoint = '/home1/cqn/data_root/CinC2021_model/best_model.pth'
    ...
    train_dataset = CinCDataset(
        mode='train',
        csv='train.csv',
        split='train_a%d_10346.npy' % (fold),
        fold=fold
    )
    ...
    log.write('----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n')
    log.write('mode    rate    iter  epoch | loss  | 房颤       | 房扑      | 长RR间期    | 窦停       | 单发室早   | 室早二联律  | 室早成对    | 室速      | 单发房早    | 房早二联律  | 房早成对    | 房速       | 房室传导阻滞| 束支阻滞    | 窦不齐     | 干扰       | 疑问      | 正常       | 窦缓       | 窦房阻滞   | 其他        | 窦速      | 室早三联律  | 房早三联律  | time        \n')
    log.write('----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n')
              # train  0.01000   0.5   0.2 | 1.11  | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 1.11 0.29 | 0 hr 05 min
    def message(rate, iter, epoch, loss, precision, recall, mode='print', train_mode = 'train'):
        ...
        text = \
            ...
            '%4.3f | '%loss +\
            ' %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | %0.2f %0.2f | '%(*precision_recall, ) +\
